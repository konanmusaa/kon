...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s\033[1;33m[KONAN] %s/%s ➙ \033[1;98m OK %s ➙\033[1;10m CP %s  %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()      
