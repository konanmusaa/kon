...
def KONAN():
    ...
    try:
        print('')
        print(f'\033[2;32m➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠') 
        fileX = input('♕ INPUT FILE | مسار الملف ♕: ')
        print(f'\033[2;32m➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠➠') 
        ...
        exit(f'''\n{M}File %s FILE PATH ERROR ❌ مسار الملف خطاء''' % fileX)
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s\033[1;33m{𓆩KONAN𓆪} %s/%s ➙ \033[1;33m  OK ➙ %s ➙\033[1;33m  CP ➙ %s %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()      
